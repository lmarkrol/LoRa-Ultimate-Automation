...
api_id = 3083142 #JANGAN DISEBARIN 
api_hash = '0ad118c0b09254087844b062ef3f4a14' #JANGAN DISEBARIN
token = '1665551618:AAFvpiCLP19vYNPVez0-wlNFdcEe8HlK2Jw' #JANGAN DISEBARIN
  
# your phone number 
phone = '6281319771165' #JANGAN DISEBARIN
...
while(1):
    ...
    if os.path.isfile('dataset.xlsx'):
        ...
        detailOutput = ''.join(("\n\n        *Output*\n",
                              "Total Gateway terpasang: " + str(Total) + "\n",
                              "Total Gateway warning: " + str(warning) + "\n",
                              "Total Gateway ok: " + str(ok) + "\n",
                              "Total Gateway error: " + str(error) + "\n",
                              "Total Power error : " + str(powerError) + "\n",
                              "Total Ethernet error: " + str(ethernetError) + "\n",
                              "Total Mobile error: " + str(mobileError) + "\n\n"))
        ...
        client.start()
        client.send_message(botUsername, 'Laporan pukul ' + laporanPukul + detailOutput + "New Gateway Down: \n" + messageDown + "\n\n" + "New Gateway Up: \n" + messageUp )
    ...
    time.sleep(3600) #Agar program berjalan selama sejam sekali
